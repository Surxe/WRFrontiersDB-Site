...
function simulateGroupedModules(preset: CharacterPreset) {
  ...
  modules_arr.forEach((entry, idx) => {
    ...
    const mGroupId = isWeapon
      ? entry.socket_name.startsWith('Shoulder_Weapon')
        ? 'Shoulder'
        : 'Torso'
      : undefined;
    ...
    if (groups.has(key)) {
      ...
      groups.set(key, {
        ...
        socketSideLabel,
        moduleGroupName:
          isWeapon && shouldShowWeaponGroups && mGroupId ? mGroupId : undefined,
      });
    }
  });
...
describe('BotItem rework - dynamic grouping logic', () => {
  it('should group weapons by module_ref and increment count (CeresLocust case)', () => {
    const preset: CharacterPreset = {
      ...
      modules: [
        {
          module_ref: 'OBJID_Module::DA_Module_ChassisGriffin.2',
          socket_name: 'None',
          parent_socket_index: -1,
        },
        {
          module_ref: 'OBJID_Module::DA_Module_TorsoDemeter.1',
          socket_name: 'Root',
          parent_socket_index: 0,
        },
        {
          module_ref: 'OBJID_Module::DA_Module_ShoulderDemeter.0',
          socket_name: 'Shoulder_L',
          parent_socket_index: 1,
        },
        {
          module_ref: 'OBJID_Module::DA_Module_Weapon_Locust.0',
          socket_name: 'Shoulder_Weapon_0',
  ...
  it('should show (Left)/(Right) labels only when shoulder IDs differ (PhantomScourge case)', () => {
    const preset: CharacterPreset = {
      ...
      modules: [
        {
          module_ref: 'OBJID_Module::DA_Module_ChassisPhantom.0',
          socket_name: 'None',
          parent_socket_index: -1,
        },
        {
          module_ref: 'OBJID_Module::DA_Module_Shoulder_L_Phantom.0',
          socket_name: 'Shoulder_L',
          parent_socket_index: 0,
        },
        {
          module_ref: 'OBJID_Module::DA_Module_Shoulder_R_Phantom.0',
          socket_name: 'Shoulder_R',
          parent_socket_index: 0,
        },
      ],
  ...
  it('should NOT use Titan-specific doubling (natural data counting)', () => {
    ...
    const titanPreset: CharacterPreset = {
      ...
      modules: [
        {
          module_ref: 'OBJID_Module::DA_Module_ChassisTitan.0',
          socket_name: 'None',
          parent_socket_index: -1,
        },
        {
          module_ref: 'OBJID_Module::DA_Module_Weapon_Heavy.0',
          socket_name: 'Shoulder_Weapon_0',
          parent_socket_index: 0,
        },
      ],
  ...
  it('should show weapon group labels when multiple weapon types exist', () => {
    const preset: CharacterPreset = {
      ...
      modules: [
        {
          module_ref: 'OBJID_Module::DA_Module_Weapon_A.0',
          socket_name: 'Shoulder_Weapon_0',
          parent_socket_index: 0,
        },
        {
          module_ref: 'OBJID_Module::DA_Module_Weapon_B.0',
          socket_name: 'Torso_Weapon_0',
          parent_socket_index: 0,
        },
      ],
